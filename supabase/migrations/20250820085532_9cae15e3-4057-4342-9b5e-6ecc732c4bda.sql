-- First create profiles for the sample users
DO $$
DECLARE
...
BEGIN
    -- Insert basic profiles first (required for foreign key)
    ...
    (roofing_provider_id, 'elite.roofing@example.com', 'Elite Roofing Solutions', 'Elite Roofing Solutions', 'provider'),
    (concrete_provider_id, 'concrete.masters@example.com', 'Concrete Masters Namibia', 'Concrete Masters Namibia', 'provider'),
    (fence_provider_id, 'secure.fence@example.com', 'Secure Fence Co.', 'Secure Fence Co.', 'provider'),
    (landscape_provider_id, 'desert.landscape@example.com', 'Desert Landscape Designs', 'Desert Landscape Designs', 'provider'),
    (paint_provider_id, 'pro.paint@example.com', 'Pro Paint Exteriors', 'Pro Paint Exteriors', 'provider'),
    (deck_provider_id, 'outdoor.living@example.com', 'Outdoor Living Specialists', 'Outdoor Living Specialists', 'provider');
